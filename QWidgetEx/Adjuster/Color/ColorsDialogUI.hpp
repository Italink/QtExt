...
public:
    ...
    ColorWidgets::GradientBar* gradient_bar;
    ...
    void setupUi(QDialog* GradientDialog)
    {
        ...
        wheel = new ColorWidgets::ColorWheel(GradientDialog);
        ...
        gradient_bar = new ColorWidgets::GradientBar(GradientDialog);
        ...
        slide_value = new ColorWidgets::GradientSlider(GradientDialog);
        ...
        slide_saturation = new ColorWidgets::GradientSlider(GradientDialog);
        ...
        slide_alpha = new ColorWidgets::GradientSlider(GradientDialog);
        ...
        slide_red = new ColorWidgets::GradientSlider(GradientDialog);
        ...
        slide_green = new ColorWidgets::GradientSlider(GradientDialog);
        ...
        slide_blue = new ColorWidgets::GradientSlider(GradientDialog);
        ...
        slide_hue = new ColorWidgets::HueSlider(GradientDialog);
        ...
        edit_hex = new ColorWidgets::ColorLineEdit(GradientDialog);
